Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhu410289616/RHWatchDog"
  ...
  s.source       = { :git => "https://github.com/zhu410289616/RHWatchDog.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "RHWatchDog/RHWatchDog/Classes/*.{h,m}"
